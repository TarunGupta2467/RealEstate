  ...
  <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-xl-6 col-sm-6 mb-6">
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="<?php echo $this->BASE_URL.'public/adminpropertypage'; ?>">
            ...
            <div class="col-xl-6 col-sm-6 mb-6">
              <div class="card text-white bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="<?php echo $this->BASE_URL.'public/adminenquirylisting'; ?>">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fa fa-angle-right"></i>
                  </span>
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Add New Slider Image 
          <a href="<?php echo $this->BASE_URL.'public/adminslider'; ?>">
